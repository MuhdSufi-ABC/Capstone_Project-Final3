...
st.markdown(
        ...
        "- **How can I identify the right career path for me?**"
            )
...
def scrape_general_data():
    urls = [
        ...
        "https://www.myskillsfuture.gov.sg/content/portal/en/career-resources/career-resources/how-to-guides/SkillsFuture-101-self-help-guide-for-skill-and-career-development.html",
        ...
        "https://www.myskillsfuture.gov.sg/content/portal/en/portal-search/portal-search.html?fq=Course_Supp_Period_To_1%3A%5B2024-10-27T00%3A00%3A00Z%20TO%20*%5D&fq=IsValid%3Atrue&q=digital"
    ]
    scraped_info = []
